...
class LegalPlan(models.Model):
    ...
    _inherit = ['mgmtsystem.nonconformity', 'documents.mixin']

    document_count = fields.Integer(compute='_compute_document_count')


    def _get_document_folder(self):
        return self.company_id.documents_nonconformities_folder if self.company_id.documents_nonconformities_settings else False

    def _check_create_documents(self):
        return self.company_id.documents_nonconformities_settings and super()._check_create_documents()

    def _get_each_cplan_domain(self):
        self.ensure_one()
        user_domain = [('res_model', '=', 'mgmtsystem.nonconformity'),('res_id', '=', self.id)]
    ...
    def set_root_model(self):
        root_model = 'mgmtsystem.nonconformity'
        return root_model
