...
class MgmtCategCommunicate(models.Model):
    _name = 'tyt.mgmt.categ.communicate'
    _description = 'Mgmt Categ Communicate'
    ...
    def action_communicate(self):
        self.ensure_one()
        template = self.env.ref('tyt_process.tyt_mgmt_categ_communicate_mail_template', raise_if_not_found=False)
