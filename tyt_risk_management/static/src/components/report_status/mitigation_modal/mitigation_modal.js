...
export class MitigationModal extends Component {
    static template = "tyt_risk_management.MitigationModal";
    ...
    async loadMitigations() {
        ...
        this.state.mitigations = await this.orm.read(
            "tyt.risk.mitigation",
            this.props.mIds,
            ["id","risk_id_auditor_id", "risk_id_reviewer_id", "risk_id_owner_id",  "risk_id_id", "risk_id_pdomain_id", "period_str"]
        );
