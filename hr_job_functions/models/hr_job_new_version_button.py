...
class Validation(models.Model):
    _name = 'mgmtsystem.validation.hr.job'
    _inherit = ['mgmtsystem.version', 'mail.thread', 'mail.activity.mixin']
    _description = 'Validación y nueva versión de PUESTOS'
    ...
    def clone_childs(self, childs):
        ...
        for child in childs:
            child.validation_state = 'elaborate'
